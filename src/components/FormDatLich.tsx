...
export default function FormDatLich({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-ink/60 backdrop-blur-sm transition-opacity">
      <div className="bg-card rounded-2xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col max-h-[90vh] animate-in fade-in zoom-in duration-200">
        ...
        <div className="px-6 py-4 border-b border-line flex justify-between items-center bg-paper">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xl font-bold text-ink">Thông tin đặt lịch</h3>
          </div>
          <button
            onClick={onHuy}
        ...
        <div className="p-6 overflow-y-auto flex flex-col gap-4">
          ...
          <div className="flex gap-2 bg-paper p-1 rounded-lg">
            <button
              type="button"
          ...
          <div>
            <label className="block text-sm font-semibold text-ink mb-1.5">Họ và tên <span className="text-rust">*</span></label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-semibold text-ink mb-1.5">Số điện thoại <span className="text-rust">*</span></label>
            <input
              type="tel"
          ...
          <div>
            <label className="block text-sm font-semibold text-ink mb-1.5">Địa chỉ sửa chữa <span className="text-rust">*</span></label>
            <ChonDiaChi onDoiDiaChi={onDoiDiaChiHen} />
          </div>

          <div>
            <label className="block text-sm font-semibold text-ink mb-1.5">Mô tả sự cố-Ghi chú đến thợ (không bắt buộc)</label>
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2.5 rounded-lg border border-line focus:ring-2 focus:ring-teal/30 focus:border-teal outline-none transition-all resize-none"
            />
          </div>
        </div>

        <div className="px-6 py-4 border-t border-line flex gap-3 bg-paper">
          <button
            onClick={onHuy}
            className="flex-1 bg-card border border-line text-ink-soft font-semibold py-2.5 rounded-lg hover:bg-line transition-colors"
          >
            Hủy bỏ
          </button>
          {cheDo === "ngay_bay_gio" ? (
